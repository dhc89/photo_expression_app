    ...
    describe '掲示板の一覧' do
      ...
      context 'ログインしている場合' do
        ...
        it '正しいタイトルが表示されていること' do
          ...
          click_on('掲示板')
          click_on('掲示板一覧')
          expect(page).to have_title("掲示板一覧 | PHOTO"), '掲示板一覧ページのタイトルに「掲示板一覧 | PHOTO」が含まれていません。'
        end
    ...
    describe '掲示板の詳細' do
      ...
      context 'ログインしている場合' do
        ...
        it '正しいタイトルが表示されていること' do
          ...
          expect(page).to have_title("#{board.title} | PHOTO"), '掲示板詳細ページのタイトルに掲示板のタイトルが含まれていません。'
        end
      end
    end
    describe '掲示板の作成' do
      ...
      context 'ログインしている場合' do
        ...
        it '正しいタイトルが表示されていること' do
          expect(page).to have_title("掲示板作成 | PHOTO"), '掲示板新規作成ページのタイトルに「掲示板作成 | PHOTO」が含まれていません。'
        end
